...
export default function Step() {
    return (
        <div className='flex flex-col gap-3 p-5'>
            <div className='text-4xl font-[600] border-b border-gray-200 leading-8 text-gray-800 shadow-sm dark:text-gray-200 w-full flex justify-center px-4 py-4 '>HINTS</div>
            <link
                ...
                {steps.map((step, i) => (
                    <div className="flex flex-col gap-3" key={i}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: "4px" }}>
                            ...
                            <span className='text-5xl font-[500] text-gray-500'>{step.title}</span>
                        </div>
                        <div
                            style={{
                                ...(i !== steps.length - 1 && {
